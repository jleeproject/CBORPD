function [ret_minval,final_xatmin,history, queries, queryVals, queryVals2, queryVals3] = diRect_nargout_func_3_module...
...
[thirds , lengths, c , fc, con, feas_flags minval,xatmin,perror,...
        history,szes,fcncounter,calltype, queries, queryVals, queryVals2, queryVals3] =...
...
[l_fc(1),l_con(1), l_feas_flags(1), point, l_fc2(1), l_fc3(1)] = ...
...
%------------------------------------------------------------------%
function [fcn_value, con_value, feas_flag, point, fcn_value2, fcn_value3] = ...
