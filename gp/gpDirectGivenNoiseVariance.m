function [infillPostGp, hyperParams, funcCovModifiaiblePost] = gpDirectGivenNoiseVariance(xx, yy, samplesizes, hyperParams, param_BO, noiseVars)
...
%     lognrndFromMeanStdDev(lengthscaleOpt, lengthscaleOpt/10), gpVarOpt, meanFuncs, noiseVars, covFunc);
    [infillPostGp, funcCovModifiaiblePost] = gpPosteriorStochasticGivenNoise([], xx, yy, ...
