classdef EstimatorGpDirectLogSampleVar < AbsEstimatorGp
    ...
    methods
        function this = EstimatorGpDirectLogSampleVar(param_BO, gpSetting)
        ...
        function [predictor, gpParam, truePredictor] = estimateGp(this, x_train, y_train, cumul_samplesizes)
            ...
            [funcHs, learnedHPs, funcCovModifiaiblePost] = gpDirectLogSampleVar(x_train, y_train, cumul_samplesizes, this.gpParam, this.param_BO);
