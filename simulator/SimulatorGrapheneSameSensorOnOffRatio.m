classdef SimulatorGrapheneSameSensorOnOffRatio  < matlab.mixin.Copyable
...
%         sigmaFunc
    ...
    methods
        function this = SimulatorGrapheneSameSensorOnOffRatio(grapheneSolver, optProb, typeProblem, changingParameterSensorOn, changingParameterSensorOff)
...
%                         samples(i) = this.grapheneSolver.evalResponseRatioWithVecX(xx, this.typeSensorOn, this.typeSensorOff);
                        if(this.hasOnOffChangingParameters)
                            samples(i) = this.grapheneSolver.evalSameSensorOnOffRatioWithVecX(xx, this.changingParameterSensorOn, this.changingParameterSensorOff);
                        else
                            samples(i) = this.grapheneSolver.evalSameSensorOnOffRatioWithVecX(xx);
                        end
                    end
