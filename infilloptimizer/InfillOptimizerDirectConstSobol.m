classdef InfillOptimizerDirectConstSobol < AbsInfillOptimizer
...
%             else
                ...
                diRectWrapMin_given_constraint( acquisition, this.xDomain, this.optParam, problem);
...
%                 [v_min, idx_max ] = max(v_train);
            ...
            funcFeas = @(arg, nouse) this.feasibilitySamplingConstraint.feasGap(multiConstrPredictors.predict(arg));
%             else
