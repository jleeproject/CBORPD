classdef InfillOptimizerDirectConstHWEI < AbsInfillOptimizer
    
    
    properties
        name = 'Weighted EI (f_opt w/in xtest, using mu_g)';
        optParam
        type = TypeInfillOptimizer.DirectConstHWEI;
        pofCalculator
        isFirstRun = true;
...
%             this.acqusitionFunc.updateFOpt(v_min);
            ...
            mu_g = multiConstrPredictors.predict(xx_train);
            feas_x_test = this.feasibilitySamplingConstraint.isThisValueFeasible(mu_g);
